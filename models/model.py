...
# https://github.com/zaqai/LGCount/tree/master/models
...
from .model_crossvit import CrossAttentionBlock, ConvCrossAttentionBlock
...
class LGCount(nn.Module):
    def __init__(self, fim_depth: int = 4,
        ...
        self.clip = self.clip.to('cuda').float()
        if unfreeze_vit:
